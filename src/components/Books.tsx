        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {books.map((book, index) => (
            ...
            >
              ...
              <div className={`w-full aspect-[3/4] rounded-lg bg-gradient-to-br ${book.color} mb-4 flex items-center justify-center relative overflow-hidden`}>
                <div className="absolute inset-0 bg-midnight/20" />
                <BookOpen className="w-12 h-12 sm:w-16 sm:h-16 text-ivory/30 relative z-10" />
                {/* Book spine effect */}
                <div className="absolute left-0 top-0 bottom-0 w-2 sm:w-3 bg-black/20" />
              </div>
